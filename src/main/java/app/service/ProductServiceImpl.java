...
import app.exceptions.ProductNotFaundExeption;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product getById(Long id) {
        ...
        if (product ==  null || !product.isActive()){
            throw  new ProductNotFaundExeption("Product with id = " + id + " not found");
        }
        return product;
    }
    ...
    public void update(Product product) {
        if (product== null){
            throw new ProductUpdateException("Product cannot not be null");
        }
    ...
    public void deleteByName(String name) {
        Product product = getAllActiveProducts().stream()
                ...
                .orElse(null);
        if (product ==  null || !product.isActive()){
            throw  new ProductNotFaundExeption("Product with name = " + name + " not found");
        }
